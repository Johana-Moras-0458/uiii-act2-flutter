      ...
      body: SafeArea(
        child: ListView(
          children: [
                ...
                children: [
                  const CircleAvatar(
                    ...
                    backgroundImage: NetworkImage(
                      "https://raw.githubusercontent.com/Johana-Moras-0458/uiii-act2-imagenes/main/perfil01.jpg"),
                  ),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 20, bottom: 30, top: 5),
              child: Column(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(user.storyImage),
                                fit: BoxFit.cover,
                              ),
                            ),
                            child: Container(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const Spacer(),
              Text(
                "${user.comment} comentarios",
                style: const TextStyle(fontSize: 16),
              ),
              const SizedBox(width: 10),
              const Text("3 compartidos", style: TextStyle(fontSize: 16)),
            ],
          ),
          ...
          Row(
            ...
            children: [
              likeCommentShare(
                Icons.thumb_up,
                user.isOnline ? Colors.blue : Colors.grey,
                "Like",
              ),
              likeCommentShare(Icons.comment, Colors.grey, "Comentarios"),
